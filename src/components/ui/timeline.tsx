...
export default function Timeline() {
    return (
        ...
        <div className="text-lg font-black">First Program</div>
        ...
        <div className="text-lg font-black">Advent of Code </div>
        Over time, I started to dabble in writing code more, although it felt uncomfortable. I partook in a seasonal activity my friend told me about, called <b> Advent of Code.</b> AOC really helped shape my ability to think as a programmer, and I got up to day 8 by hacking together solutions while trying to learn python with trusty GeeksForGeeks. 
            </div>
            <hr />
          </li>
        ...
        <time className="font-mono italic">2020</time>
            ...
            <div className="text-lg font-black">Address Book</div>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="h-5 w-5"><path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.857-9.809a.75.75 0 00-1.214-.882l-3.483 4.79-1.88-1.88a.75.75 0 10-1.06 1.061l2.5 2.5a.75.75 0 001.137-.089l4-5.5z" clipRule="evenodd" /></svg>
            ...
            <div className="timeline-end mb-10">
        <time className="font-mono italic">2020</time>
        <div className="text-lg font-black">Discord.py</div>
        ...
        <div className="text-lg font-black">Accepted to Georgia Tech</div>
