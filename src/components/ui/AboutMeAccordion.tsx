    ...
    return (
        <Accordion type="multiple" className="w-full">
         <AccordionItem value="item-1">
          ...
          <AccordionContent>I{"'"}m a Georgia Tech student who lived in Southern California until college started. I have a great interest in almost every field of programming and am always excited to learn more! </AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-2">
          <AccordionTrigger>Technologies That I am Learning</AccordionTrigger>
          <AccordionContent>
            Currently, I am learning two different languages/technologies: C++ and Nextjs. I am learning C++ in order to further my skills in developing back-end system software and high performance applications, 
        ...
        <AccordionItem value="item-3">
          ...
          <AccordionContent>Some useful classes I have/are taking include: Computer Organization and Programming, Data Structures and Algorithms,
            Objects and Design, Linear Algebra, and Intro to Object Oriented Programming. My current cumulative GPA is <b>4.0</b> </AccordionContent>
        </AccordionItem>
